...
// Main OrgsBoard Component (can be exported)
const OrgsDashboard: FC = () => {
  ...
  const handleViewOrg = (org: Organization) => {
    ...
    // Add navigation or view logic here
  };

  return (
    <div className="bg-gradient-to-br from-blue-50 to-indigo-100 h-full min-h-screen p-4 sm:p-6 lg:p-8">
      ...
      <div className="flex justify-between items-center mb-6 lg:mb-8">
        ...
        <button
          ...
          className="flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-4 lg:px-6 py-2 lg:py-3 rounded-lg font-semibold transition-colors shadow-lg text-sm lg:text-base"
        >
          Create Organization
        </button>
      </div>
